        ...
        <div className="p-2 m-4 relative ">
          <div className="relative w-[460px] h-[600px] ml-auto  ">
            <Image
              ...
              priority
            />
            <div className="absolute w-[105%] h-[102%] -top-[22px] -left-[22px]  border-t-[10px] border-l-[10px] border-accent border-[#00ffbb] " />
          </div>
        </div>

        {/* Right Section */}
        <div className="flex-grow max-w-[480px] w-[350px]  m-4 -mt-1 font-sans">
          <h1 className="text-[45px] text-accent mb-12 text-[#00ffbb] font-medium">
            About Me{" "}
            
            <span className="inline-block mb-[10px] ml-[4px] h-[6px] w-[60px] bg-accent "  />
          ...
          <h3 className="font-merriweather tracking-wide leading-[25px] font-light mb-2">
            ...
            years of experience in Mechanical Engineering, Teaching, Software
          ...
          {show && (
            <p className="text-[20px] py-2 font-light font-roboto">
              ...
              good fit, give me a{" "}
              <a href="tel:+919634090498" className="text-accent inline-flex items-center gap-1">
                call <IoCall />
              </a>{" "}
              or{" "}
              <a
